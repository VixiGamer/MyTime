...
interface WatchingContextType {
    ...
    toggleEpisodeStatus: (showId: number, episodeId: number, customDate?: string, customTime?: string) => void;
    ...
    markShowAsWatched: (showId: number, customDate?: string, customTime?: string) => void;
    markSeasonAsWatched: (showId: number, seasonNumber: number, customDate?: string, customTime?: string) => void;
    ...
    rewatchEpisode: (showId: number, episodeId: number, customDate?: string, customTime?: string) => void;
